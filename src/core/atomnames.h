...
item(WM_ICON_SIZE)
item(_KWM_WIN_ICON)
item(_CROMA_RESTART_MESSAGE)
item(_CROMA_RELOAD_THEME_MESSAGE)
item(_CROMA_SET_KEYBINDINGS_MESSAGE)
item(_CROMA_TOGGLE_VERBOSE)
item(_CTK_THEME_VARIANT)
item(_CTK_FRAME_EXTENTS)
item(_CTK_SHOW_WINDOW_MENU)
item(_CAFE_PANEL_ACTION)
item(_CAFE_PANEL_ACTION_MAIN_MENU)
item(_CAFE_PANEL_ACTION_RUN_DIALOG)
item(_CROMA_SENTINEL)
item(_CROMA_VERSION)
