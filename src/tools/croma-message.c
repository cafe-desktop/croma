...
send_restart (void)
{
  ...
  xev.xclient.display = GDK_DISPLAY_XDISPLAY (cdk_display_get_default ());
  xev.xclient.window = cdk_x11_get_default_root_xwindow ();
  xev.xclient.message_type = XInternAtom (GDK_DISPLAY_XDISPLAY (cdk_display_get_default ()),
  ...
  XSendEvent (GDK_DISPLAY_XDISPLAY (cdk_display_get_default ()),
