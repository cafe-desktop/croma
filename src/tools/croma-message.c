...
send_restart (void)
{
  ...
  xev.xclient.display = CDK_DISPLAY_XDISPLAY (cdk_display_get_default ());
  xev.xclient.window = cdk_x11_get_default_root_xwindow ();
  xev.xclient.message_type = XInternAtom (CDK_DISPLAY_XDISPLAY (cdk_display_get_default ()),
  ...
  XSendEvent (CDK_DISPLAY_XDISPLAY (cdk_display_get_default ()),
