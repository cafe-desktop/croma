...
===
 ...
 - Includes only the window manager; does not try to be a desktop
   ...
   modular. The "libvnck" library (which I also wrote) is available
   for writing croma extensions, pagers, and so on. (But libvnck
...
EWMH specification. An easy-to-use library called "libvnck" is
...
A: Feel free to use any WM you like. The reason croma follows the
   ...
   interchangeable part in the desktop. libvnck-based apps such as the
